...
describe('pageLoader', () => {
 beforeEach(async () => {
  nock('https://site.com')
   .persist()
   .get('/blog/about')
   .reply(200, () => fsp.readFile(path.resolve(__dirname,
   ...
   .reply(200, () => fsp.readFile(path.resolve(__dirname, '../__fixtures__/assets/scripts.js'),
    { encoding: 'binary' },),)
   .get('/11111')
 ...
 test('run pageLoader', async () => {
  ...
  const fixture = await fsp.readFile(path.resolve(__dirname,
